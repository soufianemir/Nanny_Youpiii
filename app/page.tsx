...
export default async function Home() {
  ...
  return <main className="authwrap"><div className="authcard"><div className="logo">Y!</div><h1>Nanny Youpiii</h1><p className="muted">Le quotidien des enfants, partagé simplement entre toutes les personnes qui s’en occupent.</p><div className="row wrap" style={{marginTop:20}}><Link className="btn brandbtn" href="/sign-up">Créer mon compte</Link><Link className="btn soft" href="/sign-in">Se connecter</Link></div></div></main>;
}
