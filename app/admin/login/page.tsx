...
export default async function AdminLoginPage({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  const configured = platformAdminConfigured();
  ...
  return <main className={styles.page}>
    <section className={styles.setup}>
      ...
      {!configured ? <>
        <div className={styles.notice}>L’accès administrateur n’est pas encore activé sur ce déploiement. Le secret doit être configuré dans les variables d’environnement Vercel.</div>
